  ...
  return (
    <div
      ...
      <div
        ...
        <a
          href="#"
          className="inline-flex items-center rounded-lg bg-black/25 px-3 py-2 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 ">
          Read more
          <svg
            aria-hidden="true"
